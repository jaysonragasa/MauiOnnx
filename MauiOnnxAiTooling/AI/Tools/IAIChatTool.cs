...
public interface IAIChatTool : IAIToolModelBase
{
	/// <summary>
	/// Executes the tool with the given parameters and returns a result string.
	/// </summary>
	/// <param name="parameters">The parameters extracted from the LLM's tool call.</param>
	/// <returns>A string representation of the result (e.g., JSON or text).</returns>
	Task<string> ExecuteAsync(List<System.Text.Json.JsonElement> parameters);
}

public class AIChatToolModel : IAIToolModelBase
{
